import { CompanyModificationsIntakeModel } from '../models/companyModificationsIntake.model.js'
...
export const CompanyModificationsIntakeController = {
  async create(req, res) {
    try {
      ...
      const created = await CompanyModificationsIntakeModel.create(payload)
