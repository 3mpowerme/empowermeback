export const MARKET_ANALYSIS_JSON_GEMINI_SCHEMA = {
  ...
  properties: {
        ...
        tamaño_mercado: {
          ...
          properties: {
            ...
            disposicion_pagar: {
              ...
              required: ['rango_clp', 'sensibilidad_precio'],
            },
          },
    ...
    finanzas: {
      ...
      properties: {
            ...
            rubro: {
              ...
              items: {
                ...
                properties: {
                  ...
                  clp: { type: 'number', minimum: 0 },
                },
                required: ['concepto', 'clp'],
              },
            },
            total_clp: { type: 'number', minimum: 0 },
          },
          required: ['rubro', 'total_clp'],
        },
        ...
        precio_promedio_clp: { type: 'number', minimum: 0 },
        ...
        punto_equilibrio: {
          ...
          properties: {
            ...
            ventas_clp: { type: 'number', minimum: 0 },
            formula: {
              type: 'string',
              description: 'Costos Fijos / (Precio - Costo Variable Unitario)',
            },
          },
          required: ['unidades', 'ventas_clp', 'formula'],
        },
        margen_esperado: {
          type: 'object',
          properties: {
