export const ANALYSIS_AND_BUSINESS_PLAN_JSON_GEMINI_SCHEMA = {
  name: 'generar_analisis_plan_negocios',
  description:
    'Genera un documento estructurado que incluye un Análisis de Viabilidad detallado y un Plan de Negocios completo, siguiendo una estructura de datos estricta. Utiliza esta herramienta solo cuando se solicite explícitamente la creación de un plan de negocios o un análisis de viabilidad.',
  parameters: {
      ...
      analisis_de_viabilidad: {
        ...
        properties: {
          meta_moneda: {
            ...
            properties: {
              locale: { type: 'string' }, // minLength: 2 eliminado
              currency: { type: 'string' }, // pattern eliminado
            },
          },
          resumen: {
            type: 'object',
            ...
            properties: {
              segmentos: {
                ...
                items: {
                  ...
                  properties: {
                    nombre: { type: 'string' },
                    edad_rango: { type: 'string' }, // pattern eliminado
                    nivel_ingreso: { type: 'string' }, // enum eliminado
              ...
              tamaño_mercado: {
                ...
                additionalProperties: false,
                properties: {
                  metodo: { type: 'string' }, // enum eliminado
                  estimacion_clientes: {
                    type: 'object',
                    additionalProperties: false,
                    properties: {
                      min: { type: 'number' }, // minimum: 0 eliminado
                      max: { type: 'number' }, // minimum: 0 eliminado
                  ...
                  disposicion_pagar: {
                    ...
                    properties: {
                      ...
                      sensibilidad_precio: { type: 'string' }, // enum eliminado
                    },
              ...
              competidores_directos: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    precio_relativo: { type: 'string' }, // enum eliminado
              ...
              competidores_indirectos: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    riesgo: { type: 'string' }, // enum eliminado
                  },
                  required: ['tipo', 'sustituto_de', 'riesgo'],
                },
              },
              saturacion_mercado: { type: 'string' }, // enum eliminado
          ...
          ubicacion_o_canal: {
            ...
            properties: {
              recomendacion: {
                ...
                additionalProperties: false,
                properties: {
                  tipo: { type: 'string' }, // enum eliminado
            ...
            properties: {
                  ...
                  rubro: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        amount: { type: 'number' }, // minimum: 0 eliminado
                      },
                      required: ['concepto', 'amount'],
                    },
                  },
                  total: { type: 'number' }, // minimum: 0 eliminado
                },
              ...
              costos_variables: {
                ...
                items: {
                  ...
                  properties: {
                    concepto: { type: 'string' },
                    porcentaje_sobre_ventas: { type: 'number' }, // min/max eliminado
                  },
                  required: ['concepto', 'porcentaje_sobre_ventas'],
                },
              },
              precio_promedio: { type: 'number' }, // minimum: 0 eliminado
              ...
              punto_equilibrio: {
                ...
                additionalProperties: false,
                properties: {
                  unidades: { type: 'number' }, // minimum: 0 eliminado
                  ventas: { type: 'number' }, // minimum: 0 eliminado
                  formula: { type: 'string' }, // Propiedad 'const' eliminada para evitar error 400
                },
              ...
              margen_esperado: {
                ...
                additionalProperties: false,
                properties: {
                  'bruto_%': { type: 'number' }, // min/max eliminado
                  'operativo_%': { type: 'number' }, // min/max eliminado
                },
          ...
          riesgos_y_mitigantes: {
            ...
            items: {
              ...
              properties: {
                riesgo: { type: 'string' },
                probabilidad: { type: 'string' }, // enum eliminado
                impacto: { type: 'string' }, // enum eliminado
          ...
          kpis_sugeridos: {
            ...
            items: {
              ...
              properties: {
                nombre: { type: 'string' },
                periodicidad: { type: 'string' }, // enum eliminado
                meta: { type: 'string' },
              },
          ...
          veredicto: {
            ...
            additionalProperties: false,
            properties: {
              nivel: { type: 'string' }, // enum eliminado
