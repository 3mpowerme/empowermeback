# legalRepresentative API

- Source route file: `src/routes/legalRepresentative.routes.js`
- Mounted prefixes: `/api/company-legal-representative`

## POST /api/company-legal-representative/:companyId

### Description
- Handler: `LegalRepresentativeController.create`
...
### Validations
- Joi middleware detected: `validate(legalRepresentativeSchema)`
...
### Example Request
```http
POST /api/company-legal-representative/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `LegalRepresentativeController.getAll`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/company-legal-representative/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `LegalRepresentativeController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/company-legal-representative/ HTTP/1.1
Host: <api-host>
```
