# companyDissolutionOfEirl API

- Source route file: `src/routes/companyDissolutionOfEirl.routes.js`
- Mounted prefixes: `/api/company-dissolution-of-eirl-request`

## POST /api/company-dissolution-of-eirl-request/:companyId

### Description
- Handler: `CompanyDissolutionOfEirlController.create`
...
### Validations
- Joi middleware detected: `validate(companyDissolutionOfEirlSchema)`
...
### Example Request
```http
POST /api/company-dissolution-of-eirl-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDissolutionOfEirlController.getAll`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/company-dissolution-of-eirl-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDissolutionOfEirlController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/company-dissolution-of-eirl-request/ HTTP/1.1
Host: <api-host>
```
