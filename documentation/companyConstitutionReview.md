# companyConstitutionReview API

- Source route file: `src/routes/companyConstitutionReview.routes.js`
- Mounted prefixes: `/api/company-constitution-review-request`

## POST /api/company-constitution-review-request/:companyId

### Description
- Handler: `ConstitutionReviewRegistryController.create`
...
### Validations
- Joi middleware detected: `validate(companyConstitutionReviewSchema)`
...
### Example Request
```http
POST /api/company-constitution-review-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConstitutionReviewRegistryController.getAll`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/company-constitution-review-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConstitutionReviewRegistryController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/company-constitution-review-request/ HTTP/1.1
Host: <api-host>
```
