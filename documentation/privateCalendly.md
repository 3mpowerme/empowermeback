...
- Source route file: `src/routes/privateCalendly.routes.js`
- Mounted prefixes: `/api/calendly`

## POST /api/calendly/event-data

### Description
- Handler: `CalendlyController.getById`
...
### Validations
- Joi middleware detected: `validate(calendlyEventDataSchema)`
...
### Example Request
```http
POST /api/calendly/event-data HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CalendlyController.get`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Description
- Handler: `CalendlyController.remove`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
DELETE /api/calendly/:id HTTP/1.1
Host: <api-host>
```
