# companyDissolutionOfSpa API

- Source route file: `src/routes/companyDissolutionOfSpa.routes.js`
- Mounted prefixes: `/api/company-dissolution-of-spa-request`

## POST /api/company-dissolution-of-spa-request/:companyId

### Description
- Handler: `CompanyDissolutionOfSpaController.create`
...
### Validations
- Joi middleware detected: `validate(companyDissolutionOfSpaSchema)`
...
### Example Request
```http
POST /api/company-dissolution-of-spa-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDissolutionOfSpaController.getAll`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/company-dissolution-of-spa-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDissolutionOfSpaController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/company-dissolution-of-spa-request/ HTTP/1.1
Host: <api-host>
```
