...
- Source route file: `src/routes/businessSector.routes.js`
- Mounted prefixes: `/api/business-sectors`

## GET /api/business-sectors/

### Description
- Handler: `BusinessSectorController.getAll`
...
### Example Request
```http
GET /api/business-sectors/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `BusinessSectorController.getById`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/business-sectors/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `BusinessSectorController.create`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(businessSectorSchema)`
...
### Example Request
```http
POST /api/business-sectors/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `BusinessSectorController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/business-sectors/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `BusinessSectorController.remove`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
DELETE /api/business-sectors/:id HTTP/1.1
Host: <api-host>
```
