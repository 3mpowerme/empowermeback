# companyShareholdersRegistry API

- Source route file: `src/routes/companyShareholdersRegistry.routes.js`
- Mounted prefixes: `/api/company-shareholders-registry-request`

## POST /api/company-shareholders-registry-request/:companyId

### Description
- Handler: `CompanyShareholdersRegistryController.create`
...
### Validations
- Joi middleware detected: `validate(companyShareholdersRegistrySchema)`
...
### Example Request
```http
POST /api/company-shareholders-registry-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyShareholdersRegistryController.getAll`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/company-shareholders-registry-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyShareholdersRegistryController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/company-shareholders-registry-request/ HTTP/1.1
Host: <api-host>
```
