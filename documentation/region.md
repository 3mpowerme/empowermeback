...
- Source route file: `src/routes/region.routes.js`
- Mounted prefixes: `/api/region`

## GET /api/region/

### Description
- Handler: `RegionController.getAll`
...
### Description
- Handler: `RegionController.getById`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Description
- Handler: `RegionController.create`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(regionSchema)`
...
### Description
- Handler: `RegionController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Description
- Handler: `RegionController.remove`
- Observed behavior: route delegates logic to controller/service/model layers.
