...
- Source route file: `src/routes/marketAnalysis.routes.js`
- Mounted prefixes: `/api/market-analysis`

## GET /api/market-analysis/

### Description
- Handler: `MarketAnalysisController.get`
...
### Example Request
```http
GET /api/market-analysis/ HTTP/1.1
Host: <api-host>
```
