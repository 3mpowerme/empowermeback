...
- Source route file: `src/routes/appointmentPlan.routes.js`
- Mounted prefixes: `/api/appointment-plan`

## GET /api/appointment-plan/

### Description
- Handler: `AppointmentPlanController.getAll`
...
### Example Request
```http
GET /api/appointment-plan/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `AppointmentPlanController.getById`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/appointment-plan/:id HTTP/1.1
Host: <api-host>
```
