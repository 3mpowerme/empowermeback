...
- Source route file: `src/routes/auth.routes.js`
- Mounted prefixes: `/api/auth`
...
### Validations
- Joi middleware detected: `validate(signupSchema)`
...
### Validations
- Joi middleware detected: `validate(loginSchema)`
- `email`: `Joi.string().email().required()`
- `password`: `Joi.string()`
...
### Validations
- Joi middleware detected: `validate(verifyEmailSchema)`
- `email`: `Joi.string().email().required()`
- `code`: `Joi.string()`
...
### Validations
- Joi middleware detected: `validate(forgotPasswordSchema)`
- `email`: `Joi.string().email().required()`
...
### Validations
- Joi middleware detected: `validate(resetPasswordSchema)`
- `email`: `Joi.string().email().required()`
- `code`: `Joi.string()`
...
### Validations
- Joi middleware detected: `validate(googleSchema)`
...
### Validations
- Joi middleware detected: `validate(logoutSchema)`
