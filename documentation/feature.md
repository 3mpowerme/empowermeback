...
- Source route file: `src/routes/feature.routes.js`
- Mounted prefixes: `/api/feature`
...
### Description
- Handler: `FeatureController.getById`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Description
- Handler: `FeatureController.create`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(featureSchema)`
...
### Description
- Handler: `FeatureController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Description
- Handler: `FeatureController.remove`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
DELETE /api/feature/:id HTTP/1.1
Host: <api-host>
```
