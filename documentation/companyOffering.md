...
- Source route file: `src/routes/companyOffering.routes.js`
- Mounted prefixes: `/api/company-offering`

## GET /api/company-offering/

### Description
- Handler: `CompanyOfferingController.getAll`
...
### Example Request
```http
GET /api/company-offering/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyOfferingController.getById`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/company-offering/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyOfferingController.create`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(companyOfferingSchema)`
...
### Example Request
```http
POST /api/company-offering/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyOfferingController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/company-offering/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyOfferingController.remove`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
DELETE /api/company-offering/:id HTTP/1.1
Host: <api-host>
```
