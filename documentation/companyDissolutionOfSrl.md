# companyDissolutionOfSrl API

- Source route file: `src/routes/companyDissolutionOfSrl.routes.js`
- Mounted prefixes: `/api/company-dissolution-of-srl-request`

## POST /api/company-dissolution-of-srl-request/:companyId

### Description
- Handler: `CompanyDissolutionOfSrlController.create`
...
### Validations
- Joi middleware detected: `validate(companyDissolutionOfSrlSchema)`
...
### Example Request
```http
POST /api/company-dissolution-of-srl-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDissolutionOfSrlController.getAll`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/company-dissolution-of-srl-request/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDissolutionOfSrlController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/company-dissolution-of-srl-request/ HTTP/1.1
Host: <api-host>
```
