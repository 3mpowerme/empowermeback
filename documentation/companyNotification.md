# companyNotification API

- Source route file: `src/routes/companyNotification.routes.js`
- Mounted prefixes: `/api/company-notifications`

## GET /api/company-notifications/:companyId

### Description
- Handler: `CompanyNotificationController.list`
...
### Example Request
```http
GET /api/company-notifications/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyNotificationController.create`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(createCompanyNotificationSchema)`
...
### Example Request
```http
POST /api/company-notifications/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyNotificationController.markAsRead`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PATCH /api/company-notifications/:companyId/:id/read HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyNotificationController.markAllAsRead`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PATCH /api/company-notifications/:companyId/read-all HTTP/1.1
Host: <api-host>
```
