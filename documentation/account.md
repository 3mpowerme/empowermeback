...
- Source route file: `src/routes/account.routes.js`
- Mounted prefixes: `/api/account`
...
### Description
- Handler: `AccountController.getCompanySetupByCompanyId`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/account/:companyId HTTP/1.1
Host: <api-host>
```
...
### Example Request
```http
PUT /api/account/:companyId HTTP/1.1
Host: <api-host>
```
