...
- Source route file: `src/routes/subscription.routes.js`
- Mounted prefixes: `/api/subscription`

## POST /api/subscription/

### Description
- Handler: `SubscriptionsController.create`
...
### Validations
- Joi middleware detected: `validate(CreateSubscriptionSchema)`
...
### Description
- Handler: `SubscriptionsController.listActive`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/subscription/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `SubscriptionsController.cancel`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(CancelSubscriptionSchema)`
- `mode`: `Joi.string()`
...
### Example Request
```http
POST /api/subscription/:id/cancel HTTP/1.1
Host: <api-host>
```
