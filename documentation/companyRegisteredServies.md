# companyRegisteredServies API

- Source route file: `src/routes/companyRegisteredServies.routes.js`
- Mounted prefixes: `/api/company-registered-services`

## GET /api/company-registered-services/:companyId

### Description
- Handler: `CompanyRegisteredServicesController.list`
...
### Example Request
```http
GET /api/company-registered-services/:companyId HTTP/1.1
Host: <api-host>
```
