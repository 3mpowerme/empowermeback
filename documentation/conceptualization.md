# conceptualization API

- Source route file: `src/routes/conceptualization.routes.js`
- Mounted prefixes: `/api/conceptualization`

## GET /api/conceptualization/

### Description
- Handler: `ConceptualizationController.getAll`
...
### Example Request
```http
GET /api/conceptualization/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConceptualizationController.getBrandBookOptions`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(brandBookOptionsSchema)`
...
### Example Request
```http
POST /api/conceptualization/brand-book-options HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConceptualizationController.createBrandBook`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(brandBookSchema)`
...
### Example Request
```http
POST /api/conceptualization/brand-book HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConceptualizationController.createLogos`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(logoSchema)`
- `offering_service_type_id`: `Joi.array()`
- `about`: `Joi.string().min(5).max(500).required()`
- `business_sector_id`: `Joi.number().integer().positive().required()`
- `brand_name`: `Joi.string().min(1).max(500).required()`
...
### Example Request
```http
POST /api/conceptualization/logo HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConceptualizationController.getLogoHistory`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/conceptualization/logo-history/:companyId HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConceptualizationController.create`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(conceptualizationSchema)`
...
### Example Request
```http
POST /api/conceptualization/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConceptualizationController.updateLogoBrandBook`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(updateBrandBookLogoSchema)`
...
### Example Request
```http
PUT /api/conceptualization/brand-book/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConceptualizationController.createBusinessPlan`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(businessPlanSchema)`
...
### Example Request
```http
POST /api/conceptualization/business-plan/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConceptualizationController.createBusinessCardMockups`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
POST /api/conceptualization/business-card-mockups/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ConceptualizationController.updateBusinessCardChosen`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(businessCardUpdateChosenSchema)`
...
### Example Request
```http
POST /api/conceptualization/business-card-mockups/:id/update-chosen HTTP/1.1
Host: <api-host>
```
