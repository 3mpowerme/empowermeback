...
- Source route file: `src/routes/marketingSource.routes.js`
- Mounted prefixes: `/api/marketing-source`

## GET /api/marketing-source/

### Description
- Handler: `MarketingSourceController.getAll`
...
### Example Request
```http
GET /api/marketing-source/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `MarketingSourceController.getById`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/marketing-source/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `MarketingSourceController.create`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(marketingSourceSchema)`
...
### Example Request
```http
POST /api/marketing-source/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `MarketingSourceController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/marketing-source/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `MarketingSourceController.remove`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
DELETE /api/marketing-source/:id HTTP/1.1
Host: <api-host>
```
