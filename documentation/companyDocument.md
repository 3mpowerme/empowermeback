...
- Source route file: `src/routes/companyDocument.routes.js`
- Mounted prefixes: `/api/company-documents`

## GET /api/company-documents/:companyId/:serviceCode

### Description
- Handler: `CompanyDocumentController.list`
...
### Example Request
```http
GET /api/company-documents/:companyId/:serviceCode HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDocumentController.upload`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
POST /api/company-documents/:companyId/:serviceCode/:isExecutive HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDocumentController.getViewUrl`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
POST /api/company-documents/:companyId/:serviceCode/:documentId/view-url HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDocumentController.listComments`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/company-documents/:companyId/:serviceCode/:documentId/comments HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `CompanyDocumentController.addComment`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(createDocumentCommentSchema)`
...
### Example Request
```http
POST /api/company-documents/:companyId/:serviceCode/:documentId/comments HTTP/1.1
Host: <api-host>
```
