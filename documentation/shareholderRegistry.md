# shareholderRegistry API

- Source route file: `src/routes/shareholderRegistry.routes.js`
- Mounted prefixes: `/api/shareholders-registry-request`

## POST /api/shareholders-registry-request/:companyId

### Description
- Handler: `ShareholderRegistryIntakeController.create`
...
### Validations
- Joi middleware detected: `validate(createShareholderRegistryIntakeSchema)`
...
### Example Request
```http
POST /api/shareholders-registry-request/:companyId HTTP/1.1
Host: <api-host>
```
