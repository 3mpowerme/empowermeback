# constitutionReviewIntake API

- Source route file: `src/routes/constitutionReviewIntake.routes.js`
- Mounted prefixes: `/api/constitution-review-request`

## POST /api/constitution-review-request/:companyId

### Description
- Handler: `ConstitutionReviewIntakeController.create`
...
### Validations
- Joi middleware detected: `validate(createConstitutionReviewIntakeSchema)`
...
### Example Request
```http
POST /api/constitution-review-request/:companyId HTTP/1.1
Host: <api-host>
```
