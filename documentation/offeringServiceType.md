# offeringServiceType API

- Source route file: `src/routes/offeringServiceType.routes.js`
- Mounted prefixes: `/api/offering-service-type`

## GET /api/offering-service-type/

### Description
- Handler: `OfferingServiceTypeController.getAll`
...
### Example Request
```http
GET /api/offering-service-type/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `OfferingServiceTypeController.getById`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
GET /api/offering-service-type/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `OfferingServiceTypeController.create`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(offeringServiceTypeSchema)`
...
### Example Request
```http
POST /api/offering-service-type/ HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `OfferingServiceTypeController.update`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
PUT /api/offering-service-type/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `OfferingServiceTypeController.remove`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
DELETE /api/offering-service-type/:id HTTP/1.1
Host: <api-host>
```
