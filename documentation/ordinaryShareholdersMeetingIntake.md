# ordinaryShareholdersMeetingIntake API

- Source route file: `src/routes/ordinaryShareholdersMeetingIntake.routes.js`
- Mounted prefixes: `/api/ordinary_shareholders_meeting-request`

## POST /api/ordinary_shareholders_meeting-request/:companyId

### Description
- Handler: `OrdinaryShareholdersMeetingIntakeController.create`
...
### Validations
- Joi middleware detected: `validate(createOrdinaryShareholdersMeetingIntakeSchema)`
...
### Example Request
```http
POST /api/ordinary_shareholders_meeting-request/:companyId HTTP/1.1
Host: <api-host>
```
