# serviceDocuments API

- Source route file: `src/routes/serviceDocuments.routes.js`
- Mounted prefixes: `/api/services`

## GET /api/services/:serviceId/documents

### Description
- Handler: `ServiceDocumentController.list`
...
### Example Request
```http
GET /api/services/:serviceId/documents HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ServiceDocumentController.updateNoteOrUpload`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Validations
- Joi middleware detected: `validate(updateServiceDocumentSchema)`
...
### Example Request
```http
PUT /api/services/:serviceId/documents/:id HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ServiceDocumentController.getUploadUrl`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
POST /api/services/:serviceId/documents/:companyId/upload-url HTTP/1.1
Host: <api-host>
```
...
### Description
- Handler: `ServiceDocumentController.getViewUrl`
- Observed behavior: route delegates logic to controller/service/model layers.
...
### Example Request
```http
POST /api/services/:serviceId/documents/:id/view-url HTTP/1.1
Host: <api-host>
```
